...
const createProject = (newProject) => {
  ...
  return db
    .query(
      'INSERT INTO Projects (user_id, title, description, budget, address, status, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *;',
...
module.exports = { createProject, getAllProjects, getProjectById, getProjectsByUserId, updateProject, removeProject };
